...
const TASTY_FONTS_UNINSTALL_OPTION_GOOGLE_API_KEY_DATA = 'tasty_fonts_google_api_key_data';
...
const TASTY_FONTS_UNINSTALL_OPTION_LOCAL_ENV_NOTICE = 'tasty_fonts_local_environment_notice_preferences';
